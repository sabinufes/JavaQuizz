                    ...
                    if (mSelectedOptionPosition == 0) {
                        when {
                            mCurrentPosition <= mQuestionList!!.size -> {
                                ...
                                Toast.makeText(this, "You've completed this quiz", Toast.LENGTH_SHORT).show()
                                val intent = Intent(this, MainActivity::class.java)
                                startActivity(intent)
                            }
                        }
                    } else{  val question= mQuestionList?.get(mCurrentPosition -1)
...
private fun selectedOptionView(tv: TextView,selectedOptionView:Int){
    defaultOptionsView()
    mSelectedOptionPosition = selectedOptionView
